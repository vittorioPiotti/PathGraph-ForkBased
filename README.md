...
#### Why PathGraph
If you need a ready-to-use library for representing path graphs with associated nodes, edges and weights, which offers advanced user interface features to represent, manage and interact with path graphs, then BoostSmartGraph is the right solution for you .
